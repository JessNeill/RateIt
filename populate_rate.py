...
def populate():
   ...
   # users=[{'user_id':4,'first_name':'Jess','last_name':'Neill','email':'hello@gmail.com','password':'supersecret'},
           #{'user_id':5,'first_name':'Isla','last_name':'Lase','email':'goodbye@hotmail.com','password':'ubersecret'},
           #{'user_id':6,'first_name':'Rosie','last_name':'Posie','email':'rosieposie@gmail.com','password':'nevertelling'}]
